...
try:
    ...
    country_code = 51               # Set your country code
    action_time = 2                 # Set time for button click action
    image_path = 'image.jpg'        # Absolute path to you image
    ...
    with open('numbers.txt', 'r') as file:
        for n in file.readlines():
            num = n.rstrip()
            # guardar lista de numeros en txt

            # Abre un archivo en modo escritura ('w'). Si el archivo no existe, se creará.
            with open('nowhatsapp.txt', 'w') as archivo:
                archivo.write(num)  # Escribe el valor en el archivo
